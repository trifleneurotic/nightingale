...
import com.southatlantic.sound.DesktopAudioClip;
import com.southatlantic.sound.MidiAudioClip;
 ...
 * </code>
 */
public abstract class SouthatlanticDesktop extends Panel implements SouthatlanticSystem {
	private SouthatlanticMain sa_main;

	/**
	 * Instantiates a new southatlantic desktop application.
	 */
	public SouthatlanticDesktop() {
		ResourceManager rm = createResourceManager();
		AudioPlayer ap = createAudioPlayer(rm);
		sa_main = new SouthatlanticMain(new GameStateEngine(createGameStateLogic(), this), rm, ap);
	}
	 ...
	 */
	protected static void main(SouthatlanticDesktop sd, Dimension panel_dimension) {
